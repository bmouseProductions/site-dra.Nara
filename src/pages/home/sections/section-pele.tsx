...
export default function SectionSentirPele() {
  return (
    <section className="bg-sentir-pele bg-background-sentir-pele bg-custom-100 bg-left-bottom bg-no-repeat md:bg-custom-80 md:bg-right-bottom lg:bg-custom-50" id="sobre">
